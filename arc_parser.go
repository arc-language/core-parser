...
func arcparserParserInit() {
	...
	staticData.SymbolicNames = []string{
		...
		"CAST", "ARROW", "RANGE", "ELLIPSIS", "EQ", "NE", "LE", "GE", "AND",
		"OR", "PLUS_ASSIGN", "MINUS_ASSIGN", "PLUS", "MINUS", "STAR", "SLASH",
		"PERCENT", "LT", "GT", "NOT", "AMP", "AT", "ASSIGN", "LPAREN", "RPAREN",
	...
	staticData.serializedATN = []int32{
		...
		116, 118, 0, 7, 1, 0, 19, 35, 2, 0, 49, 50, 61, 61, 1, 0, 43, 44, 2, 0,
		45, 46, 56, 57, 1, 0, 51, 52, 1, 0, 53, 55, 2, 0, 52, 53, 58, 59, 664,
		0, 125, 1, 0, 0, 0, 2, 141, 1, 0, 0, 0, 4, 143, 1, 0, 0, 0, 6, 145, 1,
		0, 0, 0, 8, 156, 1, 0, 0, 0, 10, 158, 1, 0, 0, 0, 12, 169, 1, 0, 0, 0,
		14, 171, 1, 0, 0, 0, 16, 197, 1, 0, 0, 0, 18, 199, 1, 0, 0, 0, 20, 224,
		1, 0, 0, 0, 22, 227, 1, 0, 0, 0, 24, 233, 1, 0, 0, 0, 26, 246, 1, 0, 0,
		0, 28, 248, 1, 0, 0, 0, 30, 252, 1, 0, 0, 0, 32, 266, 1, 0, 0, 0, 34, 268,
		1, 0, 0, 0, 36, 272, 1, 0, 0, 0, 38, 292, 1, 0, 0, 0, 40, 301, 1, 0, 0,
		0, 42, 310, 1, 0, 0, 0, 44, 325, 1, 0, 0, 0, 46, 327, 1, 0, 0, 0, 48, 329,
		1, 0, 0, 0, 50, 332, 1, 0, 0, 0, 52, 335, 1, 0, 0, 0, 54, 340, 1, 0, 0,
		0, 56, 347, 1, 0, 0, 0, 58, 367, 1, 0, 0, 0, 60, 369, 1, 0, 0, 0, 62, 380,
		1, 0, 0, 0, 64, 382, 1, 0, 0, 0, 66, 384, 1, 0, 0, 0, 68, 388, 1, 0, 0,
		0, 70, 440, 1, 0, 0, 0, 72, 442, 1, 0, 0, 0, 74, 444, 1, 0, 0, 0, 76, 446,
		1, 0, 0, 0, 78, 451, 1, 0, 0, 0, 80, 453, 1, 0, 0, 0, 82, 461, 1, 0, 0,
		0, 84, 469, 1, 0, 0, 0, 86, 477, 1, 0, 0, 0, 88, 485, 1, 0, 0, 0, 90, 490,
		1, 0, 0, 0, 92, 498, 1, 0, 0, 0, 94, 509, 1, 0, 0, 0, 96, 511, 1, 0, 0,
		0, 98, 532, 1, 0, 0, 0, 100, 543, 1, 0, 0, 0, 102, 552, 1, 0, 0, 0, 104,
		554, 1, 0, 0, 0, 106, 567, 1, 0, 0, 0, 108, 580, 1, 0, 0, 0, 110, 584,
		1, 0, 0, 0, 112, 598, 1, 0, 0, 0, 114, 602, 1, 0, 0, 0, 116, 610, 1, 0,
		0, 0, 118, 618, 1, 0, 0, 0, 120, 124, 3, 2, 1, 0, 121, 124, 3, 6, 3, 0,
		122, 124, 3, 8, 4, 0, 123, 120, 1, 0, 0, 0, 123, 121, 1, 0, 0, 0, 123,
		122, 1, 0, 0, 0, 124, 127, 1, 0, 0, 0, 125, 123, 1, 0, 0, 0, 125, 126,
		1, 0, 0, 0, 126, 128, 1, 0, 0, 0, 127, 125, 1, 0, 0, 0, 128, 129, 5, 0,
		0, 1, 129, 1, 1, 0, 0, 0, 130, 131, 5, 1, 0, 0, 131, 142, 5, 75, 0, 0,
		132, 133, 5, 1, 0, 0, 133, 137, 5, 62, 0, 0, 134, 136, 3, 4, 2, 0, 135,
		134, 1, 0, 0, 0, 136, 139, 1, 0, 0, 0, 137, 135, 1, 0, 0, 0, 137, 138,
		1, 0, 0, 0, 138, 140, 1, 0, 0, 0, 139, 137, 1, 0, 0, 0, 140, 142, 5, 63,
		0, 0, 141, 130, 1, 0, 0, 0, 141, 132, 1, 0, 0, 0, 142, 3, 1, 0, 0, 0, 143,
		144, 5, 75, 0, 0, 144, 5, 1, 0, 0, 0, 145, 146, 5, 2, 0, 0, 146, 147, 5,
		77, 0, 0, 147, 7, 1, 0, 0, 0, 148, 157, 3, 18, 9, 0, 149, 157, 3, 24, 12,
		0, 150, 157, 3, 30, 15, 0, 151, 157, 3, 36, 18, 0, 152, 157, 3, 38, 19,
		0, 153, 157, 3, 40, 20, 0, 154, 157, 3, 42, 21, 0, 155, 157, 3, 10, 5,
		0, 156, 148, 1, 0, 0, 0, 156, 149, 1, 0, 0, 0, 156, 150, 1, 0, 0, 0, 156,
		151, 1, 0, 0, 0, 156, 152, 1, 0, 0, 0, 156, 153, 1, 0, 0, 0, 156, 154,
		1, 0, 0, 0, 156, 155, 1, 0, 0, 0, 157, 9, 1, 0, 0, 0, 158, 159, 5, 17,
		0, 0, 159, 160, 5, 77, 0, 0, 160, 164, 5, 64, 0, 0, 161, 163, 3, 12, 6,
		0, 162, 161, 1, 0, 0, 0, 163, 166, 1, 0, 0, 0, 164, 162, 1, 0, 0, 0, 164,
		165, 1, 0, 0, 0, 165, 167, 1, 0, 0, 0, 166, 164, 1, 0, 0, 0, 167, 168,
		5, 65, 0, 0, 168, 11, 1, 0, 0, 0, 169, 170, 3, 14, 7, 0, 170, 13, 1, 0,
		0, 0, 171, 172, 5, 5, 0, 0, 172, 174, 5, 77, 0, 0, 173, 175, 5, 75, 0,
		0, 174, 173, 1, 0, 0, 0, 174, 175, 1, 0, 0, 0, 175, 176, 1, 0, 0, 0, 176,
		178, 5, 62, 0, 0, 177, 179, 3, 16, 8, 0, 178, 177, 1, 0, 0, 0, 178, 179,
		1, 0, 0, 0, 179, 180, 1, 0, 0, 0, 180, 182, 5, 63, 0, 0, 181, 183, 3, 44,
		22, 0, 182, 181, 1, 0, 0, 0, 182, 183, 1, 0, 0, 0, 183, 15, 1, 0, 0, 0,
		184, 189, 3, 44, 22, 0, 185, 186, 5, 68, 0, 0, 186, 188, 3, 44, 22, 0,
		187, 185, 1, 0, 0, 0, 188, 191, 1, 0, 0, 0, 189, 187, 1, 0, 0, 0, 189,
		190, 1, 0, 0, 0, 190, 194, 1, 0, 0, 0, 191, 189, 1, 0, 0, 0, 192, 193,
		5, 68, 0, 0, 193, 195, 5, 42, 0, 0, 194, 192, 1, 0, 0, 0, 194, 195, 1,
		0, 0, 0, 195, 198, 1, 0, 0, 0, 196, 198, 5, 42, 0, 0, 197, 184, 1, 0, 0,
		0, 197, 196, 1, 0, 0, 0, 198, 17, 1, 0, 0, 0, 199, 200, 5, 5, 0, 0, 200,
		201, 5, 77, 0, 0, 201, 203, 5, 62, 0, 0, 202, 204, 3, 20, 10, 0, 203, 202,
		1, 0, 0, 0, 203, 204, 1, 0, 0, 0, 204, 205, 1, 0, 0, 0, 205, 207, 5, 63,
		0, 0, 206, 208, 3, 44, 22, 0, 207, 206, 1, 0, 0, 0, 207, 208, 1, 0, 0,
		0, 208, 209, 1, 0, 0, 0, 209, 210, 3, 56, 28, 0, 210, 19, 1, 0, 0, 0, 211,
		216, 3, 22, 11, 0, 212, 213, 5, 68, 0, 0, 213, 215, 3, 22, 11, 0, 214,
		212, 1, 0, 0, 0, 215, 218, 1, 0, 0, 0, 216, 214, 1, 0, 0, 0, 216, 217,
		1, 0, 0, 0, 217, 221, 1, 0, 0, 0, 218, 216, 1, 0, 0, 0, 219, 220, 5, 68,
		0, 0, 220, 222, 5, 42, 0, 0, 221, 219, 1, 0, 0, 0, 221, 222, 1, 0, 0, 0,
		222, 225, 1, 0, 0, 0, 223, 225, 5, 42, 0, 0, 224, 211, 1, 0, 0, 0, 224,
		223, 1, 0, 0, 0, 225, 21, 1, 0, 0, 0, 226, 228, 5, 18, 0, 0, 227, 226,
		1, 0, 0, 0, 227, 228, 1, 0, 0, 0, 228, 229, 1, 0, 0, 0, 229, 230, 5, 77,
		0, 0, 230, 231, 5, 69, 0, 0, 231, 232, 3, 44, 22, 0, 232, 23, 1, 0, 0,
		0, 233, 234, 5, 6, 0, 0, 234, 235, 5, 77, 0, 0, 235, 239, 5, 64, 0, 0,
		236, 238, 3, 26, 13, 0, 237, 236, 1, 0, 0, 0, 238, 241, 1, 0, 0, 0, 239,
		237, 1, 0, 0, 0, 239, 240, 1, 0, 0, 0, 240, 242, 1, 0, 0, 0, 241, 239,
		1, 0, 0, 0, 242, 243, 5, 65, 0, 0, 243, 25, 1, 0, 0, 0, 244, 247, 3, 28,
		14, 0, 245, 247, 3, 18, 9, 0, 246, 244, 1, 0, 0, 0, 246, 245, 1, 0, 0,
		0, 247, 27, 1, 0, 0, 0, 248, 249, 5, 77, 0, 0, 249, 250, 5, 69, 0, 0, 250,
		251, 3, 44, 22, 0, 251, 29, 1, 0, 0, 0, 252, 253, 5, 7, 0, 0, 253, 254,
		5, 77, 0, 0, 254, 258, 5, 64, 0, 0, 255, 257, 3, 32, 16, 0, 256, 255, 1,
		0, 0, 0, 257, 260, 1, 0, 0, 0, 258, 256, 1, 0, 0, 0, 258, 259, 1, 0, 0,
		0, 259, 261, 1, 0, 0, 0, 260, 258, 1, 0, 0, 0, 261, 262, 5, 65, 0, 0, 262,
		31, 1, 0, 0, 0, 263, 267, 3, 34, 17, 0, 264, 267, 3, 18, 9, 0, 265, 267,
		3, 38, 19, 0, 266, 263, 1, 0, 0, 0, 266, 264, 1, 0, 0, 0, 266, 265, 1,
		0, 0, 0, 267, 33, 1, 0, 0, 0, 268, 269, 5, 77, 0, 0, 269, 270, 5, 69, 0,
		0, 270, 271, 3, 44, 22, 0, 271, 35, 1, 0, 0, 0, 272, 273, 5, 5, 0, 0, 273,
		274, 5, 77, 0, 0, 274, 275, 5, 62, 0, 0, 275, 276, 5, 18, 0, 0, 276, 277,
		5, 77, 0, 0, 277, 278, 5, 69, 0, 0, 278, 283, 3, 44, 22, 0, 279, 280, 5,
		68, 0, 0, 280, 282, 3, 22, 11, 0, 281, 279, 1, 0, 0, 0, 282, 285, 1, 0,
		0, 0, 283, 281, 1, 0, 0, 0, 283, 284, 1, 0, 0, 0, 284, 286, 1, 0, 0, 0,
		285, 283, 1, 0, 0, 0, 286, 288, 5, 63, 0, 0, 287, 289, 3, 44, 22, 0, 288,
		287, 1, 0, 0, 0, 288, 289, 1, 0, 0, 0, 289, 290, 1, 0, 0, 0, 290, 291,
		3, 56, 28, 0, 291, 37, 1, 0, 0, 0, 292, 293, 5, 8, 0, 0, 293, 294, 5, 62,
		0, 0, 294, 295, 5, 18, 0, 0, 295, 296, 5, 77, 0, 0, 296, 297, 5, 69, 0,
		0, 297, 298, 3, 44, 22, 0, 298, 299, 5, 63, 0, 0, 299, 300, 3, 56, 28,
		0, 300, 39, 1, 0, 0, 0, 301, 302, 5, 3, 0, 0, 302, 305, 5, 77, 0, 0, 303,
		304, 5, 69, 0, 0, 304, 306, 3, 44, 22, 0, 305, 303, 1, 0, 0, 0, 305, 306,
		1, 0, 0, 0, 306, 307, 1, 0, 0, 0, 307, 308, 5, 61, 0, 0, 308, 309, 3, 78,
		39, 0, 309, 41, 1, 0, 0, 0, 310, 311, 5, 4, 0, 0, 311, 314, 5, 77, 0, 0,
		312, 313, 5, 69, 0, 0, 313, 315, 3, 44, 22, 0, 314, 312, 1, 0, 0, 0, 314,
		315, 1, 0, 0, 0, 315, 316, 1, 0, 0, 0, 316, 317, 5, 61, 0, 0, 317, 318,
		3, 78, 39, 0, 318, 43, 1, 0, 0, 0, 319, 326, 3, 46, 23, 0, 320, 326, 3,
		48, 24, 0, 321, 326, 3, 50, 25, 0, 322, 326, 3, 52, 26, 0, 323, 326, 3,
		54, 27, 0, 324, 326, 5, 77, 0, 0, 325, 319, 1, 0, 0, 0, 325, 320, 1, 0,
		0, 0, 325, 321, 1, 0, 0, 0, 325, 322, 1, 0, 0, 0, 325, 323, 1, 0, 0, 0,
		325, 324, 1, 0, 0, 0, 326, 45, 1, 0, 0, 0, 327, 328, 7, 0, 0, 0, 328, 47,
		1, 0, 0, 0, 329, 330, 5, 53, 0, 0, 330, 331, 3, 44, 22, 0, 331, 49, 1,
		0, 0, 0, 332, 333, 5, 59, 0, 0, 333, 334, 3, 44, 22, 0, 334, 51, 1, 0,
		0, 0, 335, 336, 5, 36, 0, 0, 336, 337, 5, 56, 0, 0, 337, 338, 3, 44, 22,
		0, 338, 339, 5, 57, 0, 0, 339, 53, 1, 0, 0, 0, 340, 341, 5, 37, 0, 0, 341,
		342, 5, 56, 0, 0, 342, 343, 3, 44, 22, 0, 343, 344, 5, 68, 0, 0, 344, 345,
		3, 44, 22, 0, 345, 346, 5, 57, 0, 0, 346, 55, 1, 0, 0, 0, 347, 351, 5,
		64, 0, 0, 348, 350, 3, 58, 29, 0, 349, 348, 1, 0, 0, 0, 350, 353, 1, 0,
		0, 0, 351, 349, 1, 0, 0, 0, 351, 352, 1, 0, 0, 0, 352, 354, 1, 0, 0, 0,
		353, 351, 1, 0, 0, 0, 354, 355, 5, 65, 0, 0, 355, 57, 1, 0, 0, 0, 356,
		368, 3, 40, 20, 0, 357, 368, 3, 42, 21, 0, 358, 368, 3, 60, 30, 0, 359,
		368, 3, 64, 32, 0, 360, 368, 3, 66, 33, 0, 361, 368, 3, 68, 34, 0, 362,
		368, 3, 70, 35, 0, 363, 368, 3, 72, 36, 0, 364, 368, 3, 74, 37, 0, 365,
		368, 3, 76, 38, 0, 366, 368, 3, 56, 28, 0, 367, 356, 1, 0, 0, 0, 367, 357,
		1, 0, 0, 0, 367, 358, 1, 0, 0, 0, 367, 359, 1, 0, 0, 0, 367, 360, 1, 0,
		...
		56, 28, 0, 391, 392, 5, 11, 0, 0, 392, 393, 5, 10, 0, 0, 393, 394, 3, 78,
		39, 0, 394, 395, 3, 56, 28, 0, 395, 397, 1, 0, 0, 0, 396, 391, 1, 0, 0,
		0, 397, 400, 1, 0, 0, 0, 398, 396, 1, 0, 0, 0, 398, 399, 1, 0, 0, 0, 399,
		403, 1, 0, 0, 0, 400, 398, 1, 0, 0, 0, 401, 402, 5, 11, 0, 0, 402, 404,
		3, 56, 28, 0, 403, 401, 1, 0, 0, 0, 403, 404, 1, 0, 0, 0, 404, 69, 1, 0,
		0, 0, 405, 406, 5, 12, 0, 0, 406, 441, 3, 56, 28, 0, 407, 408, 5, 12, 0,
		0, 408, 409, 3, 78, 39, 0, 409, 410, 3, 56, 28, 0, 410, 441, 1, 0, 0, 0,
		411, 414, 5, 12, 0, 0, 412, 415, 3, 40, 20, 0, 413, 415, 3, 60, 30, 0,
		414, 412, 1, 0, 0, 0, 414, 413, 1, 0, 0, 0, 414, 415, 1, 0, 0, 0, 415,
		416, 1, 0, 0, 0, 416, 418, 5, 70, 0, 0, 417, 419, 3, 78, 39, 0, 418, 417,
		1, 0, 0, 0, 418, 419, 1, 0, 0, 0, 419, 420, 1, 0, 0, 0, 420, 423, 5, 70,
		0, 0, 421, 424, 3, 60, 30, 0, 422, 424, 3, 78, 39, 0, 423, 421, 1, 0, 0,
		0, 423, 422, 1, 0, 0, 0, 423, 424, 1, 0, 0, 0, 424, 425, 1, 0, 0, 0, 425,
		441, 3, 56, 28, 0, 426, 427, 5, 12, 0, 0, 427, 428, 5, 77, 0, 0, 428, 429,
		5, 13, 0, 0, 429, 430, 3, 78, 39, 0, 430, 431, 3, 56, 28, 0, 431, 441,
		1, 0, 0, 0, 432, 433, 5, 12, 0, 0, 433, 434, 5, 77, 0, 0, 434, 435, 5,
		68, 0, 0, 435, 436, 5, 77, 0, 0, 436, 437, 5, 13, 0, 0, 437, 438, 3, 78,
		39, 0, 438, 439, 3, 56, 28, 0, 439, 441, 1, 0, 0, 0, 440, 405, 1, 0, 0,
		0, 440, 407, 1, 0, 0, 0, 440, 411, 1, 0, 0, 0, 440, 426, 1, 0, 0, 0, 440,
		432, 1, 0, 0, 0, 441, 71, 1, 0, 0, 0, 442, 443, 5, 14, 0, 0, 443, 73, 1,
		0, 0, 0, 444, 445, 5, 15, 0, 0, 445, 75, 1, 0, 0, 0, 446, 449, 5, 16, 0,
		0, 447, 450, 3, 60, 30, 0, 448, 450, 3, 78, 39, 0, 449, 447, 1, 0, 0, 0,
		449, 448, 1, 0, 0, 0, 450, 77, 1, 0, 0, 0, 451, 452, 3, 80, 40, 0, 452,
		79, 1, 0, 0, 0, 453, 458, 3, 82, 41, 0, 454, 455, 5, 48, 0, 0, 455, 457,
		3, 82, 41, 0, 456, 454, 1, 0, 0, 0, 457, 460, 1, 0, 0, 0, 458, 456, 1,
		0, 0, 0, 458, 459, 1, 0, 0, 0, 459, 81, 1, 0, 0, 0, 460, 458, 1, 0, 0,
		0, 461, 466, 3, 84, 42, 0, 462, 463, 5, 47, 0, 0, 463, 465, 3, 84, 42,
		0, 464, 462, 1, 0, 0, 0, 465, 468, 1, 0, 0, 0, 466, 464, 1, 0, 0, 0, 466,
		467, 1, 0, 0, 0, 467, 83, 1, 0, 0, 0, 468, 466, 1, 0, 0, 0, 469, 474, 3,
		86, 43, 0, 470, 471, 7, 2, 0, 0, 471, 473, 3, 86, 43, 0, 472, 470, 1, 0,
		0, 0, 473, 476, 1, 0, 0, 0, 474, 472, 1, 0, 0, 0, 474, 475, 1, 0, 0, 0,
		475, 85, 1, 0, 0, 0, 476, 474, 1, 0, 0, 0, 477, 482, 3, 88, 44, 0, 478,
		479, 7, 3, 0, 0, 479, 481, 3, 88, 44, 0, 480, 478, 1, 0, 0, 0, 481, 484,
		1, 0, 0, 0, 482, 480, 1, 0, 0, 0, 482, 483, 1, 0, 0, 0, 483, 87, 1, 0,
		0, 0, 484, 482, 1, 0, 0, 0, 485, 488, 3, 90, 45, 0, 486, 487, 5, 41, 0,
		0, 487, 489, 3, 90, 45, 0, 488, 486, 1, 0, 0, 0, 488, 489, 1, 0, 0, 0,
		489, 89, 1, 0, 0, 0, 490, 495, 3, 92, 46, 0, 491, 492, 7, 4, 0, 0, 492,
		494, 3, 92, 46, 0, 493, 491, 1, 0, 0, 0, 494, 497, 1, 0, 0, 0, 495, 493,
		1, 0, 0, 0, 495, 496, 1, 0, 0, 0, 496, 91, 1, 0, 0, 0, 497, 495, 1, 0,
		0, 0, 498, 503, 3, 94, 47, 0, 499, 500, 7, 5, 0, 0, 500, 502, 3, 94, 47,
		0, 501, 499, 1, 0, 0, 0, 502, 505, 1, 0, 0, 0, 503, 501, 1, 0, 0, 0, 503,
		504, 1, 0, 0, 0, 504, 93, 1, 0, 0, 0, 505, 503, 1, 0, 0, 0, 506, 507, 7,
		6, 0, 0, 507, 510, 3, 94, 47, 0, 508, 510, 3, 96, 48, 0, 509, 506, 1, 0,
		0, 0, 509, 508, 1, 0, 0, 0, 510, 95, 1, 0, 0, 0, 511, 515, 3, 100, 50,
		0, 512, 514, 3, 98, 49, 0, 513, 512, 1, 0, 0, 0, 514, 517, 1, 0, 0, 0,
		515, 513, 1, 0, 0, 0, 515, 516, 1, 0, 0, 0, 516, 97, 1, 0, 0, 0, 517, 515,
		1, 0, 0, 0, 518, 519, 5, 71, 0, 0, 519, 533, 5, 77, 0, 0, 520, 521, 5,
		71, 0, 0, 521, 522, 5, 77, 0, 0, 522, 524, 5, 62, 0, 0, 523, 525, 3, 114,
		57, 0, 524, 523, 1, 0, 0, 0, 524, 525, 1, 0, 0, 0, 525, 526, 1, 0, 0, 0,
		...
		0, 0, 0, 552, 546, 1, 0, 0, 0, 552, 547, 1, 0, 0, 0, 552, 548, 1, 0, 0,
		0, 552, 549, 1, 0, 0, 0, 552, 550, 1, 0, 0, 0, 552, 551, 1, 0, 0, 0, 553,
		103, 1, 0, 0, 0, 554, 563, 5, 64, 0, 0, 555, 560, 3, 78, 39, 0, 556, 557,
		5, 68, 0, 0, 557, 559, 3, 78, 39, 0, 558, 556, 1, 0, 0, 0, 559, 562, 1,
		0, 0, 0, 560, 558, 1, 0, 0, 0, 560, 561, 1, 0, 0, 0, 561, 564, 1, 0, 0,
		0, 562, 560, 1, 0, 0, 0, 563, 555, 1, 0, 0, 0, 563, 564, 1, 0, 0, 0, 564,
		565, 1, 0, 0, 0, 565, 566, 5, 65, 0, 0, 566, 105, 1, 0, 0, 0, 567, 576,
		5, 64, 0, 0, 568, 573, 3, 108, 54, 0, 569, 570, 5, 68, 0, 0, 570, 572,
		3, 108, 54, 0, 571, 569, 1, 0, 0, 0, 572, 575, 1, 0, 0, 0, 573, 571, 1,
		0, 0, 0, 573, 574, 1, 0, 0, 0, 574, 577, 1, 0, 0, 0, 575, 573, 1, 0, 0,
		0, 576, 568, 1, 0, 0, 0, 576, 577, 1, 0, 0, 0, 577, 578, 1, 0, 0, 0, 578,
		579, 5, 65, 0, 0, 579, 107, 1, 0, 0, 0, 580, 581, 3, 78, 39, 0, 581, 582,
		5, 69, 0, 0, 582, 583, 3, 78, 39, 0, 583, 109, 1, 0, 0, 0, 584, 585, 5,
		77, 0, 0, 585, 594, 5, 64, 0, 0, 586, 591, 3, 112, 56, 0, 587, 588, 5,
		68, 0, 0, 588, 590, 3, 112, 56, 0, 589, 587, 1, 0, 0, 0, 590, 593, 1, 0,
		0, 0, 591, 589, 1, 0, 0, 0, 591, 592, 1, 0, 0, 0, 592, 595, 1, 0, 0, 0,
		593, 591, 1, 0, 0, 0, 594, 586, 1, 0, 0, 0, 594, 595, 1, 0, 0, 0, 595,
		596, 1, 0, 0, 0, 596, 597, 5, 65, 0, 0, 597, 111, 1, 0, 0, 0, 598, 599,
		5, 77, 0, 0, 599, 600, 5, 69, 0, 0, 600, 601, 3, 78, 39, 0, 601, 113, 1,
		0, 0, 0, 602, 607, 3, 78, 39, 0, 603, 604, 5, 68, 0, 0, 604, 606, 3, 78,
		39, 0, 605, 603, 1, 0, 0, 0, 606, 609, 1, 0, 0, 0, 607, 605, 1, 0, 0, 0,
		607, 608, 1, 0, 0, 0, 608, 115, 1, 0, 0, 0, 609, 607, 1, 0, 0, 0, 610,
		611, 5, 39, 0, 0, 611, 612, 5, 56, 0, 0, 612, 613, 3, 44, 22, 0, 613, 614,
		5, 57, 0, 0, 614, 615, 5, 62, 0, 0, 615, 616, 3, 78, 39, 0, 616, 617, 5,
		63, 0, 0, 617, 117, 1, 0, 0, 0, 618, 619, 5, 38, 0, 0, 619, 620, 5, 62,
		0, 0, 620, 623, 3, 44, 22, 0, 621, 622, 5, 68, 0, 0, 622, 624, 3, 78, 39,
		0, 623, 621, 1, 0, 0, 0, 623, 624, 1, 0, 0, 0, 624, 625, 1, 0, 0, 0, 625,
		626, 5, 63, 0, 0, 626, 119, 1, 0, 0, 0, 60, 123, 125, 137, 141, 156, 164,
		174, 178, 182, 189, 194, 197, 203, 207, 216, 221, 224, 227, 239, 246, 258,
		266, 283, 288, 305, 314, 325, 351, 367, 380, 386, 398, 403, 414, 418, 423,
		440, 449, 458, 466, 474, 482, 488, 495, 503, 509, 515, 524, 529, 532, 543,
		552, 560, 563, 573, 576, 591, 594, 607, 623,
	}
...
func (p *ArcParser) ExternFunctionDecl() (localctx IExternFunctionDeclContext) {
	...
	if (int64((_la-19)) & ^0x3f) == 0 && ((int64(1)<<(_la-19))&288231492852121599) != 0 {
		{
			p.SetState(177)
	...
	if (int64((_la-19)) & ^0x3f) == 0 && ((int64(1)<<(_la-19))&288231492843732991) != 0 {
		{
			p.SetState(181)
			p.Type_()
		}
...
func (p *ArcParser) FunctionDecl() (localctx IFunctionDeclContext) {
	...
	if (int64((_la-18)) & ^0x3f) == 0 && ((int64(1)<<(_la-18))&576460752320200705) != 0 {
		{
			p.SetState(202)
			p.ParameterList()
		}
...
func (p *ArcParser) Block() (localctx IBlockContext) {
	...
	for ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&5489888770398475800) != 0) || ((int64((_la-64)) & ^0x3f) == 0 && ((int64(1)<<(_la-64))&16129) != 0) {
		{
			p.SetState(348)
			p.Statement()
		}
...
func (p *ArcParser) ForStmt() (localctx IForStmtContext) {
	...
	case 3:
		...
		if (int64((_la-38)) & ^0x3f) == 0 && ((int64(1)<<(_la-38))&1082418839555) != 0 {
			{
				p.SetState(417)
				p.Expression()
			}
...
func (p *ArcParser) RelationalExpression() (localctx IRelationalExpressionContext) {
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&216278335230050304) != 0 {
		{
			p.SetState(478)
			_la = p.GetTokenStream().LA(1)

			if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&216278335230050304) != 0) {
				p.GetErrorHandler().RecoverInline(p)
			} else {
				p.GetErrorHandler().ReportMatch(p)
				p.Consume()
...
func (p *ArcParser) UnaryExpression() (localctx IUnaryExpressionContext) {
	...
	case ArcParserMINUS, ArcParserSTAR, ArcParserNOT, ArcParserAMP:
		p.EnterOuterAlt(localctx, 1)
		{
			...
			if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&878201927337246720) != 0) {
				p.GetErrorHandler().RecoverInline(p)
			} else {
				p.GetErrorHandler().ReportMatch(p)
				p.Consume()
